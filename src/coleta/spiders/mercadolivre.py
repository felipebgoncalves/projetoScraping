...
class MercadolivreSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for product in products:
           ...
           cents_old = product.css(
               'span.andes-money-amount__cents.andes-money-amount__cents--superscript-16::text').getall()
           cents_new = product.css(
               'span.andes-money-amount__cents.andes-money-amount__cents--superscript-24::text').getall()
